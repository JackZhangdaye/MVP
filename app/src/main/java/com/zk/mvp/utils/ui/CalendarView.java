...
public class CalendarView extends LinearLayout {
    ...
    public String getData(){
        return mSelectYear + "-" + mSelectMonth + "-" + mSelectDay;
    }
...
//        addViewData(mYearSpinnerView, lp, getYearList(), "年");
    ...
    private void initStyle(Context context, AttributeSet attrs) {
        ...
        mTextColor = typedArray.getColor(R.styleable.CalendarView_textViewColor, Color.parseColor("#999999"));
        mSelectedTextColor = typedArray.getColor(R.styleable.CalendarView_selectedTextColor, Color.parseColor("#3F51B5"));
        mSelectedLineColor = typedArray.getColor(R.styleable.CalendarView_selectedLineColor, Color.parseColor("#D6D6D6"));
        mTextSize = typedArray.getDimensionPixelSize(R.styleable.CalendarView_textViewSize, SizeUtils.sp2px(14));
        typedArray.recycle();
    }
    ...
    public void setDate(String date) {
        ...
        switch (dateArray.length) {
            case 3:
                ...
                break;
            case 2:
                mSelectMonth = Integer.valueOf(dateArray[0]);
                mSelectDay = Integer.valueOf(dateArray[1]);
                break;
            case 1:
...
//        mYearSpinnerView.setCurrentData(mSelectYear + "年");
        mMonthSpinnerView.setCurrentData(mSelectMonth  + "月");
        setDayAllDataAndCurrentData();
    }

    private void setDayAllDataAndCurrentData() {
        List<String> dayList = getDayList(mSelectYear + "-" + mSelectMonth );
    ...
    private void checkDayIsExist(List<String> dayList) {
        ...
        if(!dayList.contains(selectDayStr)) {//是否包含
            mSelectDay--;
            checkDayIsExist(dayList);
        }
    }
